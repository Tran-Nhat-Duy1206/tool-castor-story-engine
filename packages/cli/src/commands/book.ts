...
import { deriveBookIdFromTitle, normalizePlatformOrOther, PipelineRunner, StateManager, type BookConfig } from "@actalk/castor-core";
import {
...
bookCommand
  ...
  .option("--lang <language>", "Writing language: vi (Vietnamese) or en (English). Defaults from project.")
...
bookCommand
  ...
  .option("--lang <language>", "Writing language: vi or en")
  .option("--json", "Output JSON")
