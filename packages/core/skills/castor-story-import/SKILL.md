---
name: castor-story-import
description: External novel and chapter batch ingestion, segmenting, and normalization.
---
# Story import and reconstruction

Use this skill when the user wants an existing manuscript to become an editable, continuable Castor project.

- Determine the user's intent before acting:
  - `import_chapters`: the text becomes real chapters in the active book and Castor reconstructs state.
